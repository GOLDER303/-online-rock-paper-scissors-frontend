    ...
    return (
        <div className="flex flex-col flex-grow h-screen pt-10 bg-gradient-to-r from-purple-700 to-purple-600 text-white">
            ...
            <div className="flex justify-center items-center flex-grow">
                <button className="group relative block mx-auto mb-8 py-6 px-16 text-xl font-bold uppercase bg-gradient-to-r from-orange-400 to-orange-500 rounded-full shadow-lg shadow-orange-500 hover:shadow-orange-600 transition-shadow">
                    {/* Hover background */}
